            ...
            <div class="col-md-4 text-center mb-3">
                <div class="store-photo-wrapper mx-auto mb-3">
                    @if ($store->store_photo ?? false)
                        <img src="{{ Storage::url($store->store_photo) }}" class="store-photo rounded img-fluid"
                            alt="{{ $store->store_name }}">
                    @else
                        <div class="store-photo d-flex flex-column mb-0 align-items-center justify-content-center rounded">
                            <i class="fa-solid fa-shop fa-2x text-brown mt-0"></i>
                            <br>
                            <p class="text-brown">No Image</p>
                        </div>
                    @endif
                </div>

                <h4 class="card-title text-brown">{{ $store->store_name }}</h4>
